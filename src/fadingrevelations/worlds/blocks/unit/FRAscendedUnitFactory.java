package fadingrevelations.worlds.blocks.unit;
...
public class FRAscendedUnitFactory extends UnitFactory {
    ...
    public FRAscendedUnitFactory(String name) {
        super(name);
    ...
    public boolean canPlaceOn(Tile tile, Team team, int rotation){
        ...
        return !indexer.getFlagged(team, BlockFlag.factory).contains(b -> b instanceof FRAscendedBuild && getRect(Tmp.r2, b.x, b.y, b.rotation).overlaps(rect));
    }

    public class FRAscendedBuild extends UnitFactoryBuild{
                    ...
                    if(plan.unit != null) {
                        ...
                        for(int i = 0; i < 2; i++){
                            ...
                            for(int a = 0; a < 3; a++){
                                ...
                                Draw.rect(
                                        Core.atlas.find("fading-revelations-aim-shoot"),
