...
public class FREffectBlocks {
    ...
    public static void load() {
        ...
        coreLevel4 = new CoreBlock("core-level-4") {{
            ...
            size = 6; researchCostMultiplier = 0.5f; health = 36000; itemCapacity = 14000;
            unitType = FRCoreUnits.delta; unitCapModifier = 24;
        ...
        coreLevel5 = new CoreBlock("core-level-5") {{
            ...
            size = 7; researchCostMultiplier = 0.5f; health = 48000; itemCapacity = 17000;
            unitType = FRCoreUnits.epsilon; unitCapModifier = 32;
        ...
        mainCore = new FRCoreBlock("main-core") {{
            ...
            size = 8; researchCostMultiplier = 0.4f; health = 62000; itemCapacity = 21000;
            unitType = FRCoreUnits.coreTurretUnit; unitCapModifier = 40;
        ...
        corePrime = new FRCoreBlock("core-prime") {{
            ...
            size = 9; researchCostMultiplier = 0.3f; health = 78000; itemCapacity = 28000;
