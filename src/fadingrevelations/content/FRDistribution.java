...
public class FRDistribution {
    ...
    public static void load() {
        ...
        titaniumJunction = new Junction("titanium-junction") {{
            ...
            speed = 18; displayedSpeed = 19; health = 45; size = 1;
        ...
        kineticConveyor = new Conveyor("kinetic-conveyor") {{
            ...
            health = 350; speed = 0.11f; displayedSpeed = 14;
        ...
        kineticJunction = new Junction("kinetic-junction") {{
            ...
            speed = 14; displayedSpeed = 24; health = 55; size = 1;
        ...
        bioConveyor = new Conveyor("bio-conveyor") {{
            ...
            health = 600; speed = 0.16f; displayedSpeed = 20;
        ...
        bioJunction = new Junction("bio-junction") {{
            ...
            speed = 10; displayedSpeed = 32; capacity = 8; health = 220; size = 1;
        ...
        bioBridgeConveyor = new ItemBridge("bio-bridge-conveyor") {{
            ...
            health = 650; range = 10; transportTime = 1.5f; hasPower = false;
        ...
        fusionConveyor = new StackConveyor("fusion-conveyor") {{
            ...
            health = 900; speed = 0.1f; itemCapacity = 15; outputRouter = true;
