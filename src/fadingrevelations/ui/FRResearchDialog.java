...
import fadingrevelations.content.FRFullTechTree;

import static mindustry.Vars.*;
import static mindustry.gen.Tex.buttonDown;
import static mindustry.gen.Tex.buttonOver;

public class FRResearchDialog extends BaseDialog {
    public static FRResearchDialog instance;
    ...
    public static void init() {
        instance = new FRResearchDialog();
    }

    public FRResearchDialog() {
        super("");
        Vars.ui.research.fill(t -> t.update(() -> {
            if (Vars.ui.research.root.node == FRFullTechTree.rootNode) {
    ...
    public class View extends Group {
        ...
        void rebuild(@Nullable boolean[] shine) {
            ...
            checkMargin();
            Core.app.post(FRResearchDialog.this::checkMargin);
